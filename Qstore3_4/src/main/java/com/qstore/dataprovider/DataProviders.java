...
public class DataProviders {
	...
	//Class --> LoginPageTest,HomePageTest
		//Test Case--> loginTest, wishListTest, orderHistoryandDetailsTest
		...
		//Test Case--> verifyCreateAccountPageTest	
			...
			//Class --> AddToCartPageTest, EndToEndTest
			//Test Case--> addToCartTest, endToEndTest	
			...
			//Test Case--> productAvailabilityTest
